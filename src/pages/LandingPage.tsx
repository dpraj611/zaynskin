      ...
      <div className="h-screen w-screen overflow-hidden flex flex-col md:flex-row relative">
        ...
        >
          <div className="absolute inset-0 transition-all duration-700">
            <motion.div
              className={`absolute inset-0 bg-gradient-to-br from-clinic-bg via-clinic-secondary to-clinic-accent transition-opacity duration-700 ${hoveredSide === 'clinic' ? 'opacity-90' : 'opacity-0'
                }`}
            />
            <motion.div
              className={`absolute inset-0 bg-cover bg-center transition-opacity duration-700 ${hoveredSide === 'clinic' ? 'opacity-80' : 'opacity-0'
                }`}
              style={{
          ...
          <div className="absolute inset-0 flex items-center justify-center flex-col p-4 md:p-8 text-center z-10">
            <motion.div
              ...
              className="relative"
            >
              <h2 className={`text-xl md:text-4xl lg:text-6xl font-cormorant font-light mb-2 md:mb-4 transition-colors duration-700 ${hoveredSide === 'clinic' ? 'text-white' : 'text-clinic-accent'
                }`}>
                Step into Skin Science
              </h2>
              <p className={`text-sm md:text-base mb-6 md:mb-12 max-w-md mx-auto transition-colors duration-700 ${hoveredSide === 'clinic' ? 'text-white' : 'text-clinic-accent'
                }`}>
                Science-Driven Aesthetics, Personalized for You
              </p>
              <Button
        ...
        >
          <div className="absolute inset-0 transition-all duration-700">
            <motion.div
              className={`absolute inset-0 bg-gradient-to-br from-lounge-bg via-lounge-secondary to-lounge-accent transition-opacity duration-700 ${hoveredSide === 'lounge' ? 'opacity-90' : 'opacity-0'
                }`}
            />
            <motion.div
              className={`absolute inset-0 bg-cover bg-center transition-opacity duration-700 ${hoveredSide === 'lounge' ? 'opacity-80' : 'opacity-0'
                }`}
              style={{
          ...
          <div className="absolute inset-0 flex items-center justify-center flex-col p-4 md:p-8 text-center z-10">
            <motion.div
              ...
              className="relative"
            >
              <h2 className={`text-xl md:text-4xl lg:text-6xl font-pinyon mb-2 md:mb-4 transition-colors duration-700 ${hoveredSide === 'lounge' ? 'text-white' : 'text-lounge-accent'
                }`}>
                Indulge in Rejuvenation
              </h2>
              <p className={`text-sm md:text-base mb-6 md:mb-12 max-w-md mx-auto transition-colors duration-700 ${hoveredSide === 'lounge' ? 'text-white' : 'text-lounge-accent'
                }`}>
                Luxury Wellness for Mind, Body & Balance
              </p>
              <Button
      ...
      >
        <div className="p-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              <h3 className="text-3xl font-cormorant font-medium text-clinic-accent mb-8 text-center">
                Your Pathway to Lovely Skin and Healthy Hair Begins Here

              </h3>
              <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                <p> From mild skin concerns to advanced laser treatment for skin Pune patients trust, or comprehensive hair transplant clinic in Pune offerings — Zayn Skin Clinic is committed to personalized care that delivers long-lasting results.
                  We combine the best of medical knowledge with the art of beauty to make sure every client leaves walking tall, with a new found confidence, and is invigorated.
                </p>
              </div>
            </div>
            {/* What Clients Love */}
